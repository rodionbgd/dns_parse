...
#        define CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS _Pragma("clang diagnostic pop")
...
#if defined(CATCH_INTERNAL_CONFIG_CPP11_NULLPTR) && !defined(CATCH_CONFIG_CPP11_NO_NULLPTR) && \
    !defined(CATCH_CONFIG_CPP11_NULLPTR) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_NULLPTR
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_NOEXCEPT) && !defined(CATCH_CONFIG_CPP11_NO_NOEXCEPT) && \
    !defined(CATCH_CONFIG_CPP11_NOEXCEPT) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_NOEXCEPT
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_GENERATED_METHODS) && !defined(CATCH_CONFIG_CPP11_NO_GENERATED_METHODS) && \
    !defined(CATCH_CONFIG_CPP11_GENERATED_METHODS) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_GENERATED_METHODS
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_IS_ENUM) && !defined(CATCH_CONFIG_CPP11_NO_IS_ENUM) && \
    !defined(CATCH_CONFIG_CPP11_IS_ENUM) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_IS_ENUM
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_TUPLE) && !defined(CATCH_CONFIG_CPP11_NO_TUPLE) && \
    !defined(CATCH_CONFIG_CPP11_TUPLE) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_TUPLE
#endif
#if defined(CATCH_INTERNAL_CONFIG_VARIADIC_MACROS) && !defined(CATCH_CONFIG_NO_VARIADIC_MACROS) && \
    !defined(CATCH_CONFIG_VARIADIC_MACROS)
#    define CATCH_CONFIG_VARIADIC_MACROS
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_LONG_LONG) && !defined(CATCH_CONFIG_CPP11_NO_LONG_LONG) && \
    !defined(CATCH_CONFIG_CPP11_LONG_LONG) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_LONG_LONG
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_OVERRIDE) && !defined(CATCH_CONFIG_CPP11_NO_OVERRIDE) && \
    !defined(CATCH_CONFIG_CPP11_OVERRIDE) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_OVERRIDE
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_UNIQUE_PTR) && !defined(CATCH_CONFIG_CPP11_NO_UNIQUE_PTR) && \
...
// This does not affect compilation
    ...
    !defined(__JETBRAINS_IDE__)
#    define CATCH_CONFIG_COUNTER
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_SHUFFLE) && !defined(CATCH_CONFIG_CPP11_NO_SHUFFLE) && \
    !defined(CATCH_CONFIG_CPP11_SHUFFLE) && !defined(CATCH_CONFIG_NO_CPP11)
#    define CATCH_CONFIG_CPP11_SHUFFLE
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_TYPE_TRAITS) && !defined(CATCH_CONFIG_CPP11_NO_TYPE_TRAITS) && \
    !defined(CATCH_CONFIG_CPP11_TYPE_TRAITS) && !defined(CATCH_CONFIG_NO_CPP11)
...
#if !defined(CATCH_INTERNAL_CONFIG_NO_POSIX_SIGNALS) && !defined(CATCH_CONFIG_NO_POSIX_SIGNALS) && \
...
template<typename ContainerT> void deleteAll(ContainerT& container) {
    typename ContainerT::const_iterator it    = container.begin();
    typename ContainerT::const_iterator itEnd = container.end();
    for(; it != itEnd; ++it)
        delete *it;
}
template<typename AssociativeContainerT> void deleteAllValues(AssociativeContainerT& container) {
...
struct NameAndDesc {
    NameAndDesc(const char* _name = "", const char* _description = ""): name(_name), description(_description) {}

    const char* name;
    const char* description;
};

void registerTestCase(ITestCase* testCase, char const* className, NameAndDesc const& nameAndDesc,
...
struct AutoReg {
    ...
    template<typename C>
    AutoReg(void (C::*method)(), char const* className, NameAndDesc const& nameAndDesc,
            SourceLineInfo const& lineInfo) {

        registerTestCase(new MethodTestCase<C>(method), className, nameAndDesc, lineInfo);
    }
...
#    define INTERNAL_CATCH_TESTCASE2(TestName, ...)                                                  \
        ...
        namespace {                                                                                  \
        Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(&TestName, CATCH_INTERNAL_LINEINFO, \
...
#    define INTERNAL_CATCH_METHOD_AS_TEST_CASE(QualifiedMethod, ...)                                     \
        CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS                                                             \
        namespace {                                                                                      \
        Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(&QualifiedMethod, "&" #QualifiedMethod, \
                                                                 Catch::NameAndDesc(__VA_ARGS__),        \
...
#    define INTERNAL_CATCH_TEST_CASE_METHOD2(TestName, ClassName, ...)                                  \
        ...
        Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(&TestName::test, #ClassName,           \
                                                                 Catch::NameAndDesc(__VA_ARGS__),       \
                                                                 CATCH_INTERNAL_LINEINFO); /* NOLINT */ \
        }                                                                                               \
        CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS                                                          \
        void TestName::test()
...
struct AssertionInfo {
    AssertionInfo();
    AssertionInfo(char const* _macroName, SourceLineInfo const& _lineInfo, char const* _capturedExpression,
                  ResultDisposition::Flags _resultDisposition, char const* _secondArg = "");
...
template<typename T> Impl::MatchNotOf<T> Not(Impl::MatcherBase<T> const& underlyingMatcher) {
    return Impl::MatchNotOf<T>(underlyingMatcher);
}
template<typename T> Impl::MatchAllOf<T> AllOf(Impl::MatcherBase<T> const& m1, Impl::MatcherBase<T> const& m2) {
    return Impl::MatchAllOf<T>() && m1 && m2;
}
template<typename T>
Impl::MatchAllOf<T> AllOf(Impl::MatcherBase<T> const& m1, Impl::MatcherBase<T> const& m2,
                          Impl::MatcherBase<T> const& m3) {
    return Impl::MatchAllOf<T>() && m1 && m2 && m3;
}
template<typename T> Impl::MatchAnyOf<T> AnyOf(Impl::MatcherBase<T> const& m1, Impl::MatcherBase<T> const& m2) {
...
template<typename T> T& removeConst(T const& t) {
...
template<typename T1, typename T2, Operator Op> struct Evaluator {};
...
template<typename T> struct Evaluator<int const&, T* const&, IsEqualTo> {
    static bool evaluate(int lhs, T* rhs) {
        return reinterpret_cast<void const*>(lhs) == rhs;
    }
};
template<typename T> struct Evaluator<T* const&, int const&, IsEqualTo> {
    static bool evaluate(T* lhs, int rhs) {
        return lhs == reinterpret_cast<void const*>(rhs);
    }
};
template<typename T> struct Evaluator<int const&, T* const&, IsNotEqualTo> {
    static bool evaluate(int lhs, T* rhs) {
        return reinterpret_cast<void const*>(lhs) != rhs;
    }
};
template<typename T> struct Evaluator<T* const&, int const&, IsNotEqualTo> {
    static bool evaluate(T* lhs, int rhs) {
        return lhs != reinterpret_cast<void const*>(rhs);
    }
};

template<typename T> struct Evaluator<long const&, T* const&, IsEqualTo> {
    static bool evaluate(long lhs, T* rhs) {
        return reinterpret_cast<void const*>(lhs) == rhs;
    }
};
template<typename T> struct Evaluator<T* const&, long const&, IsEqualTo> {
    static bool evaluate(T* lhs, long rhs) {
        return lhs == reinterpret_cast<void const*>(rhs);
    }
};
template<typename T> struct Evaluator<long const&, T* const&, IsNotEqualTo> {
    static bool evaluate(long lhs, T* rhs) {
        return reinterpret_cast<void const*>(lhs) != rhs;
    }
};
template<typename T> struct Evaluator<T* const&, long const&, IsNotEqualTo> {
    static bool evaluate(T* lhs, long rhs) {
        return lhs != reinterpret_cast<void const*>(rhs);
    }
};
...
template<typename T> struct EnumStringMaker<T, true> {
    static std::string convert(T const& v) {
        return ::Catch::toString(static_cast<typename std::underlying_type<T>::type>(v));
    }
};
#endif
...
template<typename T, typename Allocator> std::string toString(std::vector<T, Allocator> const& v) {
    return Detail::rangeToString(v.begin(), v.end());
}
...
template<typename ArgT, typename MatcherT> class MatchExpression;

// Wraps the LHS of an expression and overloads comparison operators
// for also capturing those and RHS (if any)
template<typename T> class ExpressionLhs: public DecomposedExpression {
    public:
    ExpressionLhs(ResultBuilder& rb, T lhs): m_rb(rb), m_lhs(lhs), m_truthy(false) {}

    ExpressionLhs& operator=(const ExpressionLhs&);

    template<typename RhsT> BinaryExpression<T, Internal::IsEqualTo, RhsT const&> operator==(RhsT const& rhs) {
        return captureExpression<Internal::IsEqualTo>(rhs);
    }

    template<typename RhsT> BinaryExpression<T, Internal::IsNotEqualTo, RhsT const&> operator!=(RhsT const& rhs) {
        return captureExpression<Internal::IsNotEqualTo>(rhs);
    }

    template<typename RhsT> BinaryExpression<T, Internal::IsLessThan, RhsT const&> operator<(RhsT const& rhs) {
        return captureExpression<Internal::IsLessThan>(rhs);
    }

    template<typename RhsT> BinaryExpression<T, Internal::IsGreaterThan, RhsT const&> operator>(RhsT const& rhs) {
    ...
    void endExpression() {
        ...
        m_rb.setResultType(m_truthy).endExpression(*this);
    }
    ...
    private:
    template<Internal::Operator Op, typename RhsT> BinaryExpression<T, Op, RhsT&> captureExpression(RhsT& rhs) const {
        return BinaryExpression<T, Op, RhsT&>(m_rb, m_lhs, rhs);
    }

    template<Internal::Operator Op> BinaryExpression<T, Op, bool> captureExpression(bool rhs) const {
...
template<typename LhsT, Internal::Operator Op, typename RhsT> class BinaryExpression: public DecomposedExpression {
    public:
    BinaryExpression(ResultBuilder& rb, LhsT lhs, RhsT rhs): m_rb(rb), m_lhs(lhs), m_rhs(rhs) {}

    BinaryExpression& operator=(BinaryExpression&);

    void endExpression() const {
        m_rb.setResultType(Internal::Evaluator<LhsT, RhsT, Op>::evaluate(m_lhs, m_rhs)).endExpression(*this);
    }
...
template<typename ArgT, typename MatcherT> class MatchExpression: public DecomposedExpression {
    public:
...
template<typename T> ExpressionLhs<T const&> ResultBuilder::operator<=(T const& operand) {
...
template<typename ArgT, typename MatcherT>
void ResultBuilder::captureMatch(ArgT const& arg, MatcherT const& matcher, char const* matcherString) {
...
#    define INTERNAL_CATCH_REACT(resultBuilder) resultBuilder.react();
...
#    define INTERNAL_CATCH_TEST_NO_TRY(macroName, resultDisposition, expr)                                         \
        do {                                                                                                       \
            Catch::ResultBuilder __catchResult(macroName, CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(expr), \
                                               resultDisposition);                                                 \
            __catchResult.setExceptionGuard();                                                                     \
            CATCH_INTERNAL_SUPPRESS_PARENTHESES_WARNINGS(__catchResult <= expr).endExpression();                   \
            ...
            false &&                                                                                               \
            static_cast<bool>(                                                                                     \
                !!(expr))))  // expr here is never evaluated at runtime but it forces the compiler to give it a look
// The double negation silences MSVC's C4800 warning, the static_cast forces short-circuit evaluation if the type has
// overloaded &&.
...
#define INTERNAL_CATCH_THROWS(macroName, resultDisposition, matcher, expr)                                     \
    do {                                                                                                       \
        Catch::ResultBuilder __catchResult(macroName, CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(expr), \
                                           resultDisposition, CATCH_INTERNAL_STRINGIFY(matcher));              \
...
template<typename T> class CompositeGenerator {
    ...
    CompositeGenerator(CompositeGenerator& other): m_fileInfo(other.m_fileInfo), m_totalSize(0) {
        move(other);
    }
    ...
    operator T() const {
        ...
        return T();  // Suppress spurious "not all control paths return a value" warning in Visual Studio - if you know
                     // how to fix this please do so
    }
...
class Approx {
    ...
    friend bool operator==(double lhs, Approx const& rhs) {
        // Thanks to Richard Harris for his help refining this formula
        bool relativeOK = std::fabs(lhs - rhs.m_value) <
...
template<> inline std::string toString<Detail::Approx>(Detail::Approx const& value) {
...
template<typename T> struct ContainsElementMatcher: MatcherBase<std::vector<T>, T> {
...
template<typename T> struct ContainsMatcher: MatcherBase<std::vector<T>, std::vector<T>> {
...
template<typename T> struct EqualsMatcher: MatcherBase<std::vector<T>, std::vector<T>> {
...
template<typename T> class Option {
    ...
    Option(Option const& _other): nullableValue(_other ? new(storage) T(*_other) : CATCH_NULL) {}
...
struct TestCaseInfo {
    ...
    TestCaseInfo(std::string const& _name, std::string const& _className, std::string const& _description,
                 std::set<std::string> const& _tags, SourceLineInfo const& _lineInfo);
...
TestCase makeTestCase(ITestCase* testCase, std::string const& className, std::string const& name,
                      std::string const& description, SourceLineInfo const& lineInfo);
}  // namespace Catch
...
class Config: public SharedImpl<IConfig> {
    ...
    bool listExtraInfo() const {
        return m_data.listExtraInfo;
    }
    ...
    virtual TestSpec const& testSpec() const CATCH_OVERRIDE {
        return m_testSpec;
    }
    ...
    // IConfig interface
    virtual bool allowThrows() const CATCH_OVERRIDE {
    ...
    virtual unsigned int rngSeed() const CATCH_OVERRIDE {
    ...
    virtual int abortAfter() const CATCH_OVERRIDE {
...
// Now set the actual defines based on the above + anything the user has configured
#            if defined(CLARA_INTERNAL_CONFIG_CPP11_NULLPTR) && !defined(CLARA_CONFIG_CPP11_NO_NULLPTR) && \
                !defined(CLARA_CONFIG_CPP11_NULLPTR) && !defined(CLARA_CONFIG_NO_CPP11)
#                define CLARA_CONFIG_CPP11_NULLPTR
#            endif
#            if defined(CLARA_INTERNAL_CONFIG_CPP11_NOEXCEPT) && !defined(CLARA_CONFIG_CPP11_NO_NOEXCEPT) && \
                !defined(CLARA_CONFIG_CPP11_NOEXCEPT) && !defined(CLARA_CONFIG_NO_CPP11)
#                define CLARA_CONFIG_CPP11_NOEXCEPT
#            endif
#            if defined(CLARA_INTERNAL_CONFIG_CPP11_GENERATED_METHODS) &&                                              \
                !defined(CLARA_CONFIG_CPP11_NO_GENERATED_METHODS) && !defined(CLARA_CONFIG_CPP11_GENERATED_METHODS) && \
                !defined(CLARA_CONFIG_NO_CPP11)
#                define CLARA_CONFIG_CPP11_GENERATED_METHODS
#            endif
#            if defined(CLARA_INTERNAL_CONFIG_CPP11_OVERRIDE) && !defined(CLARA_CONFIG_NO_OVERRIDE) && \
                !defined(CLARA_CONFIG_CPP11_OVERRIDE) && !defined(CLARA_CONFIG_NO_CPP11)
#                define CLARA_CONFIG_CPP11_OVERRIDE
#            endif
#            if defined(CLARA_INTERNAL_CONFIG_CPP11_UNIQUE_PTR) && !defined(CLARA_CONFIG_NO_UNIQUE_PTR) && \
                !defined(CLARA_CONFIG_CPP11_UNIQUE_PTR) && !defined(CLARA_CONFIG_NO_CPP11)
...
template<typename ConfigT> class BoundArgFunction {
    ...
    BoundArgFunction(BoundArgFunction const& other):
        functionObj(other.functionObj ? other.functionObj->clone() : CLARA_NULL) {}
...
template<typename ConfigT> class CommandLine {
    ...
    std::vector<Parser::Token> populateOptions(std::vector<Parser::Token> const& tokens, ConfigT& config) const {
        ...
        if(!errors.empty()) {
            std::ostringstream oss;
            for(std::vector<std::string>::const_iterator it = errors.begin(), itEnd = errors.end(); it != itEnd; ++it) {
                if(it != errors.begin())
                    oss << "\n";
                oss << *it;
            }
...
inline void addSectionToRun(ConfigData& config, std::string const& sectionName) {
    config.sectionsToRun.push_back(sectionName);
}
...
inline void setWaitForKeypress(ConfigData& config, std::string const& keypress) {
    ...
    if(keypressLc == "start")
        ...
        throw std::runtime_error("keypress argument must be one of: start, exit or both. '" + keypress +
                                 "' not recognised");
};
...
inline Clara::CommandLine<ConfigData> makeCommandLineParser() {
    ...
    cli["-b"]["--break"].describe("break into debugger on failure").bind(&ConfigData::shouldDebugBreak);
    ...
    cli["-f"]["--input-file"].describe("load test names to run from a file").bind(&loadTestNamesFromFile, "filename");

    cli["-#"]["--filenames-as-tags"].describe("adds a tag for the filename").bind(&ConfigData::filenamesAsTags);

    cli["-c"]["--section"].describe("specify section to run").bind(&addSectionToRun, "section name");
    ...
    cli["--list-extra-info"].describe("list all/matching test cases with more info").bind(&ConfigData::listExtraInfo);
    ...
    cli["--force-colour"].describe("force colourised output (deprecated)").bind(&forceColour);

    cli["--use-colour"].describe("should output be colourised").bind(&setUseColour, "yes|no");
...
struct TextAttributes {
    TextAttributes(): initialIndent(std::string::npos), indent(0), width(consoleWidth - 1) {}
...
class Text {
    ...
    Text(std::string const& _str, TextAttributes const& _attr = TextAttributes()): attr(_attr) {
        ...
        std::string indent = _attr.initialIndent != std::string::npos ? std::string(_attr.initialIndent, ' ') :
        ...
        while(it != strEnd) {
            ...
            std::string suffix;
            std::size_t width =
                (std::min)(static_cast<size_t>(strEnd - it), _attr.width - static_cast<size_t>(indent.size()));
...
struct TagInfo {
    ...
    std::string all() const {
        std::string out;
        for(std::set<std::string>::const_iterator it = spellings.begin(), itEnd = spellings.end(); it != itEnd; ++it)
            out += "[" + *it + "]";
        return out;
    }
...
inline std::size_t listTags(Config const& config) {
    ...
    for(std::map<std::string, TagInfo>::const_iterator countIt = tagCounts.begin(), countItEnd = tagCounts.end();
        ...
        Text wrapper(
            countIt->second.all(),
            TextAttributes().setInitialIndent(0).setIndent(oss.str().size()).setWidth(CATCH_CONFIG_CONSOLE_WIDTH - 10));
...
inline std::size_t listReporters(Config const& /*config*/) {
    ...
    for(it = itBegin; it != itEnd; ++it) {
        ...
        Catch::cout() << "  " << it->first << ':' << std::string(maxNameLen - it->first.size() + 2, ' ') << wrapper
                      << '\n';
    }
    Catch::cout() << std::endl;
...
struct NameAndLocation {
    ...
    NameAndLocation(std::string const& _name, SourceLineInfo const& _location): name(_name), location(_location) {}
};
...
class TrackerContext {
    ...
    TrackerContext(): m_currentTracker(CATCH_NULL), m_runState(NotStarted) {}
...
class TrackerBase: public ITracker {
    ...
    virtual ITracker* findChild(NameAndLocation const& nameAndLocation) CATCH_OVERRIDE {
        Children::const_iterator it =
            std::find_if(m_children.begin(), m_children.end(), TrackerHasName(nameAndLocation));
        return (it != m_children.end()) ? it->get() : CATCH_NULL;
    }
...
class StdErrRedirect {
    ...
    StdErrRedirect(std::string& targetString):
        m_cerrBuf(cerr().rdbuf()),
        m_clogBuf(clog().rdbuf()),
        m_targetString(targetString) {
...
class RunContext: public IResultCapture, public IRunner {
    ...
    ResultBuilder makeUnexpectedResultBuilder() const {
        return ResultBuilder(m_lastAssertionInfo.macroName, m_lastAssertionInfo.lineInfo,
                             m_lastAssertionInfo.capturedExpression, m_lastAssertionInfo.resultDisposition);
    }
...
Ptr<IStreamingReporter> makeReporter(Ptr<Config> const& config) {
    ...
    for(std::vector<std::string>::const_iterator it = reporters.begin(), itEnd = reporters.end(); it != itEnd; ++it)
        reporter = addReporter(reporter, createReporter(*it, config));
    return reporter;
}
Ptr<IStreamingReporter> addListeners(Ptr<IConfig const> const& config, Ptr<IStreamingReporter> reporters) {
    IReporterRegistry::Listeners listeners = getRegistryHub().getReporterRegistry().getListeners();
    for(IReporterRegistry::Listeners::const_iterator it = listeners.begin(), itEnd = listeners.end(); it != itEnd; ++it)
...
Totals runTests(Ptr<Config> const& config) {
    ...
    for(std::vector<TestCase>::const_iterator it = allTestCases.begin(), itEnd = allTestCases.end(); it != itEnd;
        ++it) {
...
class Session: NonCopyable {
    ...
    int applyCommandLine(int argc, char const* const* const argv,
...
void enforceNoDuplicateTestCases(std::vector<TestCase> const& functions) {
    ...
    for(std::vector<TestCase>::const_iterator it = functions.begin(), itEnd = functions.end(); it != itEnd; ++it) {
        ...
        if(!prev.second) {
            ...
            ss << Colour(Colour::Red) << "error: TEST_CASE( \"" << it->name << "\" ) already defined.\n"
...
void registerTestCase(ITestCase* testCase, char const* classOrQualifiedMethodName, NameAndDesc const& nameAndDesc,
                      SourceLineInfo const& lineInfo) {
...
AutoReg::AutoReg(TestFunction function, SourceLineInfo const& lineInfo, NameAndDesc const& nameAndDesc) {
...
class RegistryHub: public IRegistryHub, public IMutableRegistryHub {
    ...
    virtual void registerTagAlias(std::string const& alias, std::string const& tag,
                                  SourceLineInfo const& lineInfo) CATCH_OVERRIDE {
...
class Context: public IMutableContext {
    ...
    IGeneratorsForTest* findGeneratorsForCurrentTest() {
        ...
        return it != m_generatorsByTestName.end() ? it->second : CATCH_NULL;
    }
...
IColourImpl* platformColourInstance() {
    ...
    UseColour::YesOrNo colourMode = config ? config->useColour() : UseColour::Auto;
    if(colourMode == UseColour::Auto)
        colourMode = (!isDebuggerActive() && isatty(STDOUT_FILENO)) ? UseColour::Yes : UseColour::No;
...
AssertionInfo::AssertionInfo():
    macroName(""),
    capturedExpression(""),
    resultDisposition(ResultDisposition::Normal),
    secondArg("") {}

AssertionInfo::AssertionInfo(char const* _macroName, SourceLineInfo const& _lineInfo, char const* _capturedExpression,
                             ResultDisposition::Flags _resultDisposition, char const* _secondArg):
...
std::string AssertionResult::getExpressionInMacro() const {
    if(m_info.macroName[0] == 0)
        ...
        return std::string(m_info.macroName) + "( " +
               capturedExpressionWithSecondArgument(m_info.capturedExpression, m_info.secondArg) + " )";
}
...
inline void enforceNotReservedTag(std::string const& tag, SourceLineInfo const& _lineInfo) {
    if(isReservedTag(tag)) {
        std::ostringstream ss;
        ss << Colour(Colour::Red) << "Tag name [" << tag << "] not allowed.\n"
...
TestCase makeTestCase(ITestCase* _testCase, std::string const& _className, std::string const& _name,
                      std::string const& _descOrTags, SourceLineInfo const& _lineInfo) {
...
namespace Catch {
LegacyReporterAdapter::LegacyReporterAdapter(Ptr<IReporter> const& legacyReporter): m_legacyReporter(legacyReporter) {}
...
void LegacyReporterAdapter::testCaseEnded(TestCaseStats const& testCaseStats) {
    m_legacyReporter->EndTestCase(testCaseStats.testInfo, testCaseStats.totals, testCaseStats.stdOut,
...
void ResultBuilder::captureExpectedException(Matchers::Impl::MatcherBase<std::string> const& matcher) {
    ...
    data.reconstructedExpression =
        capturedExpressionWithSecondArgument(m_assertionInfo.capturedExpression, m_assertionInfo.secondArg);
...
std::string TagAliasRegistry::expandAliases(std::string const& unexpandedTestSpec) const {
    ...
    for(std::map<std::string, TagAlias>::const_iterator it = m_registry.begin(), itEnd = m_registry.end(); it != itEnd;
        ++it) {
...
void TagAliasRegistry::add(std::string const& alias, std::string const& tag, SourceLineInfo const& lineInfo) {
    ...
    if(!startsWith(alias, "[@") || !endsWith(alias, ']')) {
        std::ostringstream oss;
        oss << Colour(Colour::Red) << "error: tag alias, \"" << alias << "\" is not of the form [@alias name].\n"
            << Colour(Colour::FileName) << lineInfo << '\n';
        throw std::domain_error(oss.str().c_str());
    }
    if(!m_registry.insert(std::make_pair(alias, TagAlias(tag, lineInfo))).second) {
        std::ostringstream oss;
        oss << Colour(Colour::Red) << "error: tag alias, \"" << alias << "\" already registered.\n"
...
struct TestEventListenerBase: StreamingReporterBase {
    TestEventListenerBase(ReporterConfig const& _config): StreamingReporterBase(_config) {}
...
class XmlWriter {
    ...
    XmlWriter(std::ostream& os): m_tagIsOpen(false), m_needsNewline(false), m_os(os) {
        writeDeclaration();
    }
...
class JunitReporter: public CumulativeReporterBase {
    ...
    void writeGroup(TestGroupNode const& groupNode, double suiteTime) {
        ...
        // Write test cases
        for(TestGroupNode::ChildNodes::const_iterator it = groupNode.children.begin(), itEnd = groupNode.children.end();
            it != itEnd; ++it)
            writeTestCase(**it);
    ...
    void writeSection(std::string const& className, std::string const& rootName, SectionNode const& sectionNode) {
        ...
        for(SectionNode::ChildSections::const_iterator it    = sectionNode.childSections.begin(),
    ...
    void writeAssertions(SectionNode const& sectionNode) {
        for(SectionNode::Assertions::const_iterator it    = sectionNode.assertions.begin(),
    ...
    void writeAssertion(AssertionStats const& stats) {
        ...
        if(!result.isOk()) {
            ...
            for(std::vector<MessageInfo>::const_iterator it    = stats.infoMessages.begin(),
...
struct ConsoleReporter: StreamingReporterBase {
    ConsoleReporter(ReporterConfig const& _config): StreamingReporterBase(_config), m_headerPrinted(false) {}
    ...
    class AssertionPrinter {
        ...
        void printMessage() const {
            if(!messageLabel.empty())
                stream << messageLabel << ':' << '\n';
            for(std::vector<MessageInfo>::const_iterator it = messages.begin(), itEnd = messages.end(); it != itEnd;
                ++it) {
...
struct CompactReporter: StreamingReporterBase {
    ...
    CompactReporter(ReporterConfig const& _config): StreamingReporterBase(_config) {}
    ...
    void printTotals(const Totals& totals) const {
        if(totals.testCases.total() == 0) {
            ...
            const std::string qualify_assertions_failed = totals.assertions.failed == totals.assertions.total() ?
                                                              ...
                                                              std::string();
            stream << "Failed " << bothOrAll(totals.testCases.failed) << pluralise(totals.testCases.failed, "test case")
                   << ", "
                      "failed "
            ...
            stream << "Passed " << bothOrAll(totals.testCases.passed) << pluralise(totals.testCases.passed, "test case")
...
#        define CATCH_REQUIRE_FALSE(expr)                     \
            INTERNAL_CATCH_TEST_NO_TRY("CATCH_REQUIRE_FALSE", \
                                       Catch::ResultDisposition::Normal | Catch::ResultDisposition::FalseTest, expr)
#    else
...
#    define CATCH_REQUIRE_THROWS(expr) \
        INTERNAL_CATCH_THROWS("CATCH_REQUIRE_THROWS", Catch::ResultDisposition::Normal, "", expr)
...
#    define CATCH_REQUIRE_THROWS_WITH(expr, matcher) \
        INTERNAL_CATCH_THROWS("CATCH_REQUIRE_THROWS_WITH", Catch::ResultDisposition::Normal, matcher, expr)
#    define CATCH_REQUIRE_NOTHROW(expr) \
        INTERNAL_CATCH_NO_THROW("CATCH_REQUIRE_NOTHROW", Catch::ResultDisposition::Normal, expr)
...
#    define CATCH_CHECK_FALSE(expr)              \
        INTERNAL_CATCH_TEST("CATCH_CHECK_FALSE", \
                            Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::FalseTest, expr)
#    define CATCH_CHECKED_IF(expr) \
        INTERNAL_CATCH_IF("CATCH_CHECKED_IF", Catch::ResultDisposition::ContinueOnFailure, expr)
#    define CATCH_CHECKED_ELSE(expr) \
        INTERNAL_CATCH_ELSE("CATCH_CHECKED_ELSE", Catch::ResultDisposition::ContinueOnFailure, expr)
...
#    define CATCH_CHECK_THROWS(expr) \
        INTERNAL_CATCH_THROWS("CATCH_CHECK_THROWS", Catch::ResultDisposition::ContinueOnFailure, "", expr)
#    define CATCH_CHECK_THROWS_AS(expr, exceptionType)                                                                \
        INTERNAL_CATCH_THROWS_AS("CATCH_CHECK_THROWS_AS", exceptionType, Catch::ResultDisposition::ContinueOnFailure, \
                                 expr)
#    define CATCH_CHECK_THROWS_WITH(expr, matcher) \
        INTERNAL_CATCH_THROWS("CATCH_CHECK_THROWS_WITH", Catch::ResultDisposition::ContinueOnFailure, matcher, expr)
#    define CATCH_CHECK_NOTHROW(expr) \
        INTERNAL_CATCH_NO_THROW("CATCH_CHECK_NOTHROW", Catch::ResultDisposition::ContinueOnFailure, expr)
...
#        define CATCH_REQUIRE_THAT(arg, matcher) \
            INTERNAL_CHECK_THAT_NO_TRY("CATCH_REQUIRE_THAT", matcher, Catch::ResultDisposition::Normal, arg)
#    else
#        define CATCH_REQUIRE_THAT(arg, matcher) \
...
#        define CATCH_REGISTER_TEST_CASE(function, name, description) \
            INTERNAL_CATCH_REGISTER_TESTCASE(function, name, description)
#        define CATCH_SECTION(name, description) INTERNAL_CATCH_SECTION(name, description)
#        define CATCH_FAIL(msg) \
            INTERNAL_CATCH_MSG("CATCH_FAIL", Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, msg)
#        define CATCH_FAIL_CHECK(msg)                                                 \
            INTERNAL_CATCH_MSG("CATCH_FAIL_CHECK", Catch::ResultWas::ExplicitFailure, \
                               Catch::ResultDisposition::ContinueOnFailure, msg)
#        define CATCH_SUCCEED(msg) \
            INTERNAL_CATCH_MSG("CATCH_SUCCEED", Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, msg)
#    endif
...
#        define REQUIRE_FALSE(expr)                     \
            INTERNAL_CATCH_TEST_NO_TRY("REQUIRE_FALSE", \
                                       Catch::ResultDisposition::Normal | Catch::ResultDisposition::FalseTest, expr)
...
#    define REQUIRE_THROWS_WITH(expr, matcher) \
        INTERNAL_CATCH_THROWS("REQUIRE_THROWS_WITH", Catch::ResultDisposition::Normal, matcher, expr)
...
#    define CHECK_THROWS(expr) \
        INTERNAL_CATCH_THROWS("CHECK_THROWS", Catch::ResultDisposition::ContinueOnFailure, "", expr)
...
#    define CHECK_THROWS_WITH(expr, matcher) \
        INTERNAL_CATCH_THROWS("CHECK_THROWS_WITH", Catch::ResultDisposition::ContinueOnFailure, matcher, expr)
#    define CHECK_NOTHROW(expr) \
        INTERNAL_CATCH_NO_THROW("CHECK_NOTHROW", Catch::ResultDisposition::ContinueOnFailure, expr)
...
#        define REQUIRE_THAT(arg, matcher) \
            INTERNAL_CHECK_THAT_NO_TRY("REQUIRE_THAT", matcher, Catch::ResultDisposition::Normal, arg)
#    else
#        define REQUIRE_THAT(arg, matcher) \
...
#        define METHOD_AS_TEST_CASE(method, name, description) \
            INTERNAL_CATCH_METHOD_AS_TEST_CASE(method, name, description)
#        define REGISTER_TEST_CASE(method, name, description) \
            INTERNAL_CATCH_REGISTER_TESTCASE(method, name, description)
#        define SECTION(name, description) INTERNAL_CATCH_SECTION(name, description)
#        define FAIL(msg) \
            INTERNAL_CATCH_MSG("FAIL", Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, msg)
#        define FAIL_CHECK(msg)                                                 \
            INTERNAL_CATCH_MSG("FAIL_CHECK", Catch::ResultWas::ExplicitFailure, \
                               Catch::ResultDisposition::ContinueOnFailure, msg)
#        define SUCCEED(msg) \
            INTERNAL_CATCH_MSG("SUCCEED", Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, msg)
#    endif
